  ...
  <div class="container">
    ...
    <div class="base_info" v-if="userData != null">
      <span class="avatar"
        ><AnchorAvatarVue
          ...
          :isForbidden="userData.userStatus == 2" :violated="userData.userAuth==4" :authed="userData.userAuth==2"
    ...
    <div class="register_and_more_info" v-if="userData != null">
      ...
      <div v-if="userData.violateCount">
        {{multiLan('Overall violation times')}}：<span>{{ userData.violateCount }}</span>
      </div>
